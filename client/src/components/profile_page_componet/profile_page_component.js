...
const ProfilePageComponent = ({match}) => {

    const CurentProfileUser = userData.find(user => user.id == match.params.userId)
       ...
       <div  className='profile_page__content'>
           ...
           <IconContext.Provider value={{size:'1.5rem', className:'profile_page__icons'}}>
             <div className='profile_page__country'>
              <strong> Country :</strong>  <FaFlag /> {CurentProfileUser.country}
             </div>
             
             <div className='profile_page__location'>
              <strong> Current Location :</strong>  <FaMapMarkedAlt /> {CurentProfileUser.currentLocation}
             </div>
             <div className='profile_page__country'>
               <strong>From :</strong> <FaMapMarkerAlt /> {CurentProfileUser.from}
             </div>
